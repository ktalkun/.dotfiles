...
alias ggho="cd ~"
alias gget="cd /etc"
alias ggco="cd ~/.config"
alias ggcs="cd ~/.cscripts"
alias ggde="cd /dev"
alias ggdw="cd ~/Downloads"
alias ggdo="cd ~/Documents"
alias ggdt="cd ~/.dotfiles"
alias ggop="cd /opt"
alias ggpi="cd ~/Pictures"
alias ggpr="cd ~/Projects"
alias ggme="cd /media"
alias ggmo="cd /mnt"
alias ggmu="cd ~/Music"
alias ggmp="cd /tmp"
